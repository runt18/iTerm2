...
def getheadingname(m):
    ...
    if autogeneratedheading:
        ...
        headingname = "{0!s}_nn{1:d}".format(filenamebase, nameindex)
    return headingname
...
for s in lines:
    ...
    if m:
        ...
        result.append("""<H2><a name="{0!s}"></a>{1:d}. {2!s}</H2>""".format(headingname, section, prevheadingtext))
        ...
        index += """<li><a href="#{0!s}">{1!s}</a>\n""".format(headingname, prevheadingtext)
        subsection = 0
        subsubsection = 0
        subsubsubsection = 0
        skipspace = 1        
    ...
    if m:
        ...
        subsection += 1
        headingname = getheadingname(m)
        result.append("""<H3><a name="{0!s}"></a>{1:d}.{2:d} {3!s}</H3>""".format(headingname, section, subsection, prevheadingtext))
    ...
    if m:
        ...
        subsubsubsection = 0
        headingname = getheadingname(m)
        result.append("""<H4><a name="{0!s}"></a>{1:d}.{2:d}.{3:d} {4!s}</H4>""".format(headingname, section, subsection, subsubsection, prevheadingtext))
    ...
    if m:
        ...
        subsubsubsection += 1
        headingname = getheadingname(m)
        result.append("""<H5><a name="{0!s}"></a>{1:d}.{2:d}.{3:d}.{4:d} {5!s}</H5>""".format(headingname, section, subsection, subsubsection, subsubsubsection, prevheadingtext))
